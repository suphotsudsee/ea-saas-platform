...
// Process license heartbeat (alias for EA heartbeat — validates + processes)
// This is a convenience endpoint that checks license + sends heartbeat
// ─────────────────────────────────────────────────────────────────────────────

import { NextRequest, NextResponse } from 'next/server';
import { validateLicenseMiddleware } from '@/api/middleware/validateLicense';
import { processHeartbeat } from '@/api/services/ea-contract.service';
